...
function Lesson_09() {
  ...
  // const onSearch = ()=>{ console.log(searchInputValue);};
  ...
  const [searchRandomJokeValue, setSearchRandomJokeValue] =
    useState<string>("");
  const [catFact, setCatFact] = useState<string | undefined>(undefined); // создание стейта для шутки
  const [error, setError] = useState<string | undefined>(undefined); // создание стейта для ошибки
